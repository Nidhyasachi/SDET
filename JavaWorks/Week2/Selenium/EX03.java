...
public class EX03 extends ExtReports {
//public class EX03 {
	...
	public void tc_shoppingCartTesting(String item2Search, String qty, String customerName, String customerCity,
		...
		extentReport.addSystemInfo("Host Name", "SDETTraining.com").addSystemInfo("Environment", "Fannie Mae Selenium Automation Testing Week2").addSystemInfo("User Name", "IK");
		...
		FileUtils.copyFile(screenshot,new File("C:\\Users\\Huser\\Desktop\\Screenshot\\" + customerName + "screenshot.jpg"));
