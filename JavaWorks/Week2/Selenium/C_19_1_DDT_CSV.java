...
public class C_19_1_DDT_CSV {
	...
	public void tc_shoppingCartTesting() throws InterruptedException, IOException{
		...
		String csvTestDataFilePath ="C:\\121718\\ShoppingCartTestData1.csv";
		String resultsToCSV ="C:\\121718\\ShoppingCartTestDataRESULTS.csv";
		
		System.out.println(csvTestDataFilePath);
		System.out.println(resultsToCSV);
       ...
       int numberOfHeaders=testdata.getHeaderCount();
        ...
        while (testdata.readRecord())
        {
    		...
    		String qty=testdata.get("Qty");
    		customerName=testdata.get("CustomerName");
    		String customerCity=testdata.get("CustomerCity");
    		String customerState=testdata.get("CustomerState");
	...
	//    Log.info("customerState: " + customerState);
	    ...
	    driver.findElement(By.name("txtshipPhone")).sendKeys("2021114455");
	      ...
	      FileUtils.copyFile(screenshot, new File("C:\121718\\screenshot\\" + customerName + "screenshot.jpg"));
